...
const EmployeeForm = () => {
    ...
    return (
        ...
        >
            <Heading size="lg" mb={6} textAlign="center" color="fg" >Add New Employee</Heading>
            <form onSubmit={handleSubmit(onSubmit)} noValidate>
                <Fieldset.Root size="md" maxW="md" gap="6" mx="auto">
                    <Stack align="center">
                        <Fieldset.Legend  color="fg.muted">Enter employee details below</Fieldset.Legend>
                    ...
                    <Fieldset.Content gap="5" width="full">
                        ...
                        <Field.Root invalid={!!errors.name} width="full">
                            <Field.Label color="blue.600" _dark={{ color: "blue.300" }}>Name</Field.Label>
                            <Input
                        ...
                        <Field.Root invalid={!!errors.email} width="full">
                            <Field.Label color="blue.600" _dark={{ color: "blue.300" }}>Email</Field.Label>
                            <Input
                                type="email"
                        ...
                        <Field.Root invalid={!!errors.age} width="full">
                            <Field.Label color="blue.600" _dark={{ color: "blue.300" }}>Age</Field.Label>
                            <Controller
                                control={control}
                                name="age"
                                defaultValue=""
                        ...
                        <Field.Root invalid={!!errors.role} width="full">
                            <Field.Label color="blue.600" _dark={{ color: "blue.300" }}>Role</Field.Label>
                            <NativeSelect.Root>
                                <NativeSelect.Field
